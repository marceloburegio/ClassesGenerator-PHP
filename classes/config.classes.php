...
function __autoload($strClass) {
	...
	$arrClasses['JSON']                       = "util/JSON.php";
	$arrClasses['Zip']                        = "util/Zip.php";
	...
	elseif (preg_match("/^(Controlador(.*)|(Cadastro|IRepositorio)(.+)|Repositorio(.+)(BDR|XML|WS|TXT|LDAP)(Customizado)?|(.+)(NaoCadastradoException|JaCadastradoException|InexistenteException))$/", $strClass, $arrClass)) {
