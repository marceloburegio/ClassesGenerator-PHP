...
$(document).ready(function() {
	...
	$("#atributos").append(html_atributos);
	...
	$("form#formEditarClasse").bind("submit", function() {
		var mensagem = "";
		var bolIsFocus = true;
		var bolIsValid = true;
		...
		if (bolIsValid) {
			$.post("xt_editarClasse.php", $(this).serializeArray(), function(res, textStatus) {
				...
				if (textStatus != "success") mensagem = "Ocorreu um erro de comunica&ccedil;&atilde;o com o servidor. Por favor, tente novamente.";
					...
					mensagem = "Classes alteradas com sucesso!";
					resposta = true;
				}
